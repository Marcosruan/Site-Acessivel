  ...
  return (
    <footer className="w-full bg-white border-t-2 border-[#2187FF] shadow-[0_-5px_10px_rgba(4,97,207,0.15)] mt-20">
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-[#595959] leading-relaxed max-w-sm">
            Uma plataforma dedicada ao ensino inclusivo, combinando recursos visuais, 
            tecnologias assistivas e ferramentas de tradução em Libras para garantir 
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-[#595959]">Receba avisos de novas matérias e exercícios:</p>
          <form onSubmit={handleSubmitNewsletter} className="flex gap-2 w-full max-w-md">
            <input 
              type="email" 
      ...
      <div className="bg-[#064EA4] text-white text-center py-4 px-4 text-xs font-light">
        <p>© {new Date().getFullYear()} Site Acessível. Desenvolvido focando em inclusão e diversidade na Web.</p>
      </div>
    </footer>
  );
}